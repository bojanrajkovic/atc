...
The runbook for verifying multi-replica fan-out (kubectl commands, expected
broadcast behaviour, diagnostic queries) lives in
[`docs/operator/multi-replica-smoke-test.md`](../operator/multi-replica-smoke-test.md).
