      ...
      window.__stores!.runStore!.jobsByRun.set(999n, [
        {
          ...
          conclusion: null,
          runner: { id: 1n, name: 'runner-1', groupName: 'linux' },
          labels: ['linux'],
          steps: [],
          createdAt: new Date().toISOString(),
          startedAt: new Date().toISOString(),
      ...
      window.__stores!.runStore!.jobsByRun.set(998n, [
        {
          ...
          status: 'InProgress' as const,
          conclusion: null,
          runner: { id: 2n, name: 'runner-2', groupName: 'linux' },
          labels: ['linux', 'x86'],
          steps: [],
          createdAt: new Date().toISOString(),
          startedAt: new Date().toISOString(),
    ...
    await page.evaluate(() => {
      window.__stores!.runStore!.jobsByRun.set(997n, [
        // Pool 1: windows/x64 with groupName 'windows'
        {
          ...
          status: 'InProgress' as const,
          conclusion: null,
          runner: { id: 10n, name: 'win-runner', groupName: 'windows' },
          labels: ['windows', 'x64'],
          steps: [],
          createdAt: new Date().toISOString(),
          startedAt: new Date().toISOString(),
        ...
        // Pool 2: linux/self-hosted/x86/big-runners with groupName 'foo'
        {
          ...
          status: 'InProgress' as const,
          conclusion: null,
          runner: { id: 11n, name: 'linux-runner-1', groupName: 'foo' },
        ...
        },
        {
          ...
          status: 'InProgress' as const,
          conclusion: null,
          runner: { id: 12n, name: 'linux-runner-2', groupName: 'foo' },
          labels: ['linux', 'self-hosted', 'x86', 'big-runners'],
          steps: [],
          createdAt: new Date().toISOString(),
          startedAt: new Date().toISOString(),
        ...
        // Pool 3: macos/arm64 with groupName 'macos'
        {
          ...
          status: 'InProgress' as const,
          conclusion: null,
          runner: { id: 13n, name: 'macos-runner', groupName: 'macos' },
          labels: ['macos', 'arm64'],
          steps: [],
          createdAt: new Date().toISOString(),
          startedAt: new Date().toISOString(),
