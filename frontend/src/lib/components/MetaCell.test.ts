...
describe('MetaCell', () => {
  it('renders label and value text when value is provided', () => {
  ...
  it('renders default placeholder — when value is null', () => {
  ...
  it('renders default placeholder — when value is empty string', () => {
    render(MetaCell, { props: { label: 'Runner', value: '' } })

    expect(screen.getByText('—')).toBeTruthy()
  })

  it('renders custom placeholder when value is null and placeholder is provided', () => {
