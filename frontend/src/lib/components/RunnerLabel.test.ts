...
describe('RunnerLabel', () => {
  describe('run-cards.AC9.1: renders summary with ⊞ prefix in mono font', () => {
  ...
  describe('run-cards.AC9.2: renders multi-word summary with ⊞ prefix', () => {
  ...
  describe('run-cards.AC9.3: null summary renders nothing', () => {
  ...
  describe('run-cards.AC9.4: long summary uses truncate class', () => {
