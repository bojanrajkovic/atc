...
Last verified: 2026-05-07 (state-externalization rollout closed: Phase 5 metrics shipped (#63); in-memory mode reframed as dev-only; remaining Phase 5 deferrals tracked at #64, #65, #66, #67; #50 still open for PersistentStore trait cleanup)
